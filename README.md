...
CI strict-exports a temporary project with this repository as `GITCI_SCREENS_TEMPLATES_ROOT`, which keeps the canonical pack honest against the current public CLI and verifies screenshots, gallery output, and zip packaging.
